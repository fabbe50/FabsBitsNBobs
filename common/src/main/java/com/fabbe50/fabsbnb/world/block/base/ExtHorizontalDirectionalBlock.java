...
public abstract class ExtHorizontalDirectionalBlock extends HorizontalDirectionalBlock implements IDropSelf, ITooltip {
    ...
    public ExtHorizontalDirectionalBlock(int tooltipLines, Properties properties) {
        super(properties);
