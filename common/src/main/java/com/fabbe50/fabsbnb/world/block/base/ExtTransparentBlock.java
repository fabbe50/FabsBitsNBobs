...
public class ExtTransparentBlock extends TransparentBlock implements ITooltip, IDropSelf {
    private final int tooltipLines;

    public ExtTransparentBlock(Properties properties) {
        this(0, properties);
    }

    public ExtTransparentBlock(int tooltipLines, Properties properties) {
        super(properties);
