...
public class Recipes extends RecipeProvider {
    ...
    protected void buildRecipes() {
        ...
        this.shaped(RecipeCategory.TRANSPORTATION, ModRegistries.ITEM_SLOW_PUSHER_BLOCK.get(), 8)
                .pattern("ISI")
                .pattern("RSR")
                .pattern("ISI")
                ...
                .save(this.output);
        this.shapeless(RecipeCategory.TRANSPORTATION, ModRegistries.ITEM_NORMAL_PUSHER_BLOCK.get(), 2)
                .requires(Items.IRON_INGOT, 1)
                .requires(Items.REDSTONE, 1)
                .requires(ModRegistries.ITEM_SLOW_PUSHER_BLOCK.get(), 2)
                .unlockedBy("has_slow_pusher", has(ModRegistries.ITEM_SLOW_PUSHER_BLOCK.get()))
                .group(FabsBnB.MOD_ID + "_pushers")
                .save(this.output, FabsBnB.locationString("normal_pusher_block_upgrade"));
        this.shaped(RecipeCategory.TRANSPORTATION, ModRegistries.ITEM_NORMAL_PUSHER_BLOCK.get(), 8)
                .pattern("ISI")
                .pattern("RSR")
                .pattern("ISI")
                .define('I', Items.IRON_INGOT)
                ...
                .group(FabsBnB.MOD_ID + "_pushers")
                .save(this.output);
        this.shapeless(RecipeCategory.TRANSPORTATION, ModRegistries.ITEM_FAST_PUSHER_BLOCK.get(), 2)
                .requires(Items.IRON_INGOT)
                .requires(Items.REDSTONE)
                .requires(ModRegistries.ITEM_NORMAL_PUSHER_BLOCK.get(), 2)
                .unlockedBy("has_normal_pusher", has(ModRegistries.ITEM_NORMAL_PUSHER_BLOCK.get()))
                .group(FabsBnB.MOD_ID + "_pushers")
                .save(this.output, FabsBnB.locationString("fast_pusher_block_upgrade"));
        this.shaped(RecipeCategory.TRANSPORTATION, ModRegistries.ITEM_FAST_PUSHER_BLOCK.get(), 8)
                .pattern("ISI")
                .pattern("RSR")
                .pattern("ISI")
                .define('I', Items.IRON_INGOT)
